...
public class SearchCOSTLIESTfoodController implements Initializable {
    ...
    public void costliestFoodinRestaurant(ActionEvent event) {
        ...
        foodToShow = (ArrayList<Food>) RDS.searchCostliestFood(name);
