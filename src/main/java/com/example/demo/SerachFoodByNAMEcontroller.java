...
public class SerachFoodByNAMEcontroller implements Initializable {
    ...
    public void FOODsearchName(ActionEvent event) {
        ...
        foodToShow = (ArrayList<Food>) RDS.searchFoodByName(name);
