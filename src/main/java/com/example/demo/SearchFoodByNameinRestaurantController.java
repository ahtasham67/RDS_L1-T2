...
public class SearchFoodByNameinRestaurantController implements Initializable {
    ...
    public void FOODsearchNameAndRestaurant(ActionEvent event) {
        ...
        foodToShow = (ArrayList<Food>) RDS.searchFoodByNameOrestaurant(name,restName);
