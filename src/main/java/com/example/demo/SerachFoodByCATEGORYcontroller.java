...
public class SerachFoodByCATEGORYcontroller implements Initializable {
    ...
    public void FOODsearchCategory(ActionEvent event) {
        ...
        foodToShow = (ArrayList<Food>) RDS.searchFoodbyCategory(name);
