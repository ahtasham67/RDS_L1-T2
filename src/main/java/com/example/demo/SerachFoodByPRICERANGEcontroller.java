...
public class SerachFoodByPRICERANGEcontroller implements Initializable {
    ...
    public void FOODsearchbyPriceRange(ActionEvent event) {
...
//            }
//        }
        foodToShow = (ArrayList<Food>) RDS.searchFoodbyPriceRange(num1,num2);
