...
public class SearchRestaurantByPRICEcontroller implements Initializable {
    ...
    public void searchPrice(ActionEvent actionEvent) {
        ...
        restaurantsToShow = (ArrayList<Restaurant>) RDS.searchRestaurantbyPrice(name);
