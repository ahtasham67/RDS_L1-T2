...
public class SerachFoodByPRICERANGEinRESTAURANTcontroller implements Initializable {
    ...
    public void FOODsearchbyPriceRangeinRESTAuRANT(ActionEvent event) {
        ...
        String restaurantName=textFieldName11.getText();
        if (start.equals("") || end.equals("")||restaurantName.equals("")) {
...
//            }
//        }
        foodToShow = (ArrayList<Food>) RDS.foodInrangeInRestaurant(num1,num2,restaurantName);
